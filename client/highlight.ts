...
// https://github.com/adobe/brackets/blob/master/src/LiveDevelopment/Agents/RemoteFunctions.js

let _remoteHighlight
const HIGHLIGHT_CLASSNAME = '__brackets-ld-highlight'
...
export class Highlight {
  ...
  constructor(color, trigger: boolean) {
    this.color = color
  ...
  clear() {
    let i
    const highlights = window.document.querySelectorAll('.' + HIGHLIGHT_CLASSNAME),
      body = window.document.body
